...
train_data = pd.read_csv("./PRO135_Project_Template-main/static/assets/datafiles/updated_product_dataset.csv")
training_sentences = []
...
model = load_model("./PRO135_Project_Template-main/static/assets/model/sentiment_analysis_model.h5")
